...
namespace Waffle\Commons\Contracts\Constant;
...
final class Constant
{
    ...
    public const string ATTR_CLASSNAME = '_' . self::CLASSNAME;
    public const string WEB = 'web';
    public const string CONTROLLER = 'controller';
    public const string ATTR_CONTROLLER = '_' . self::CONTROLLER;
    public const string METHOD = 'method';
    public const string ATTR_METHOD = '_' . self::METHOD;
